...
\newcommand{\epicsys}{
    {\large\textbf{Epic Systems}} \hfill \textbf{Madison, WI} \\
    \textbf{Software Engineer} \hfill \textbf{June 2025 -- Present}
    \begin{itemize}
...
\newcommand{\matmul}{
    \textbf{Strassen-Winograd Matrix Multiply for GPUs} {\small\textit{CUDA, C++, Nsight}} \hfill \textbf{Jan 2025 -- May 2025}
    \begin{itemize}
...
\newcommand{\betlang}{
    \textbf{BET Programming Language \& Compiler} {\small\textit{Rust, ASM}} \hfill \textbf{Aug 2024 -- Dec 2024}
    \begin{itemize}
